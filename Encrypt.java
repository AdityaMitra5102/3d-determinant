...
class Encrypt
{
    ...
    void show()
    {
        if(privateKey==0)
        {
            System.out.println("\nError! Either public keys are invalid or this matrix cannot be encrypted with these public keys on this algorithm. Try with different public keys.");
            return;
        }
